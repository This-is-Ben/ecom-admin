                    ...
                    <CommandGroup heading='Stores'>
                        {formattedItems.map((store) => (
                            <CommandItem
                                ...
                                className="text-sm hover:bg-gray-200 p-1 cursor-pointer"
                            >
                ...
                <CommandList>
                    <CommandGroup>
                        <CommandItem
                            ...
                            className="flex flex-wrap pt-1 text-sm font-semibold hover:bg-gray-200 cursor-pointer"
                        >
                            <PlusCircle className="mr-2 h-5 w-5 ml-2"/>
                            Create Store
                        </CommandItem>
                    </CommandGroup>
                </CommandList>
